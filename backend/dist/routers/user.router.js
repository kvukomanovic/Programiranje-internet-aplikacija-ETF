...
usersRouter.route('/block').post((req, res) => new user_controller_1.UsersController().block(req, res));
usersRouter.route('/unblock').post((req, res) => new user_controller_1.UsersController().unblock(req, res));
usersRouter.route('/denyRequest').post((req, res) => new user_controller_1.UsersController().denyRequest(req, res));
usersRouter.route('/deleteResNotif').post((req, res) => new user_controller_1.UsersController().deleteResNotif(req, res));
